...
const BlinkTypography = styled((props) => <Typography variant="h1" component="span" {...props} />)(() => ({
  animation: `${myKeyframe} 2s infinite ease-in`,
}))
        ...
        <Container sx={{ pt: 5, pb: 5 }}>
          <Grid container spacing={2}>
            <Grid item container xs={6}>
              <Grid item container md={12} xs={12} sx={{ alignItems: "center" }}>
                <Box>
                  <Typography variant="h1">
                    Private Server
                    <br />
                    Network
                    <BlinkTypography>_</BlinkTypography>
                  </Typography>
                  <Typography variant="body2">
                    Cloud, GameServer, Hosting, Kubernetes, Docker, <br />
                    Database, Storage
                  </Typography>
                </Box>
              </Grid>
            ...
            <Grid item xs={12} sm>
              <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="100%" viewBox="0 0 1139.07 783.9">
                <defs>
                  <linearGradient
                    id="a555fdc1-543d-4707-ad9f-6ab871925265-20"
                    x1="403.53"
                    y1="329.2"
                    x2="403.53"
                    y2="58.05"
                  ...
                  <linearGradient
                    id="b5cd2d76-14a4-40b4-8065-15ea8dd506d0-21"
                    x1="517.81"
                    y1="472.14"
                    x2="647.31"
                    y2="472.14"
                    gradientTransform="translate(-58.47 81.57) rotate(-5.9)"
                    xlinkHref="#a555fdc1-543d-4707-ad9f-6ab871925265-20"
                  />
                </defs>
                <title>going up</title>
                <path
                  d="M824,293.65a7.55,7.55,0,0,0,1.37-4.2c0-9.12-18.58-16.5-41.5-16.5s-41.5,7.38-41.5,16.5a7.78,7.78,0,0,0,1.71,4.68c-25.52,2.85-42.71,8.19-42.71,14.32,0,9.11,38,16.5,85,16.5s85-7.39,85-16.5C871.32,302,852,296.35,824,293.65Z"
                ...
                <g opacity="0.2">
                  <path
                    d="M940.55,771.87a47.86,47.86,0,0,0-.43,7.86q26.14.42,52.51,1.76c.12-.68.24-1.39.34-2.1a41.75,41.75,0,0,0-2.45-21.72c-3.62-8.83-10.37-15.14-18.82-16.35s-16.69,2.94-22.64,10.35A41.66,41.66,0,0,0,940.55,771.87Z"
                    transform="translate(-30.47 -58.05)"
                    fill="#3f3d56"
                  />
                  <ellipse
                  ...
                  />
                  <path
                    d="M894.87,380.46a126.23,126.23,0,0,0,15.71,81.47,126.82,126.82,0,1,0,197.33,28.36C1127.8,471.35,896.89,366.37,894.87,380.46Z"
                    transform="translate(-30.47 -58.05)"
                    opacity="0.1"
                  />
                </g>
                <g opacity="0.2">
                  <path
                    d="M196.93,734.8a40.64,40.64,0,0,0,1.75,6.64q21.31-6.86,43.06-13c-.08-.6-.17-1.22-.28-1.84a36.8,36.8,0,0,0-7.78-17.36c-5.29-6.33-12.45-9.71-19.63-8.38s-12.76,7-15.61,14.84A37.31,37.31,0,0,0,196.93,734.8Z"
                    transform="translate(-30.47 -58.05)"
                    fill="#3f3d56"
                  />
                  <ellipse
                ...
                />
                <path
                  d="M295.21,199.77c1.5-.87,3.52,0,4.55,1.36a10.71,10.71,0,0,1,1.58,4.9c.57,3.81,1,8.17-1.57,11a35.83,35.83,0,0,1,29.55-23.87"
                  transform="translate(-30.47 -58.05)"
                  fill="none"
                  stroke="#6c63ff"
                  strokeMiterlimit="10"
                ...
                />
                <path
                  d="M745.21,229.77c1.5-.87,3.52,0,4.55,1.36a10.71,10.71,0,0,1,1.58,4.9c.57,3.81,1,8.17-1.57,11a35.83,35.83,0,0,1,29.55-23.87"
                  transform="translate(-30.47 -58.05)"
                  fill="none"
                  stroke="#6c63ff"
                  strokeMiterlimit="10"
                ...
                />
                <path
                  d="M708.32,566v-24.3l11.2,11.2,2.8-2.9-16-16-16,16,2.8,2.79,11.2-11.09V566Z"
                  transform="translate(-30.47 -58.05)"
                  fill="#fe5e41"
                  opacity="0.1"
                />
                <path
                  d="M466.32,646v-24.3l11.2,11.2,2.8-2.9-16-16-16,16,2.8,2.79,11.2-11.09V646Z"
                  transform="translate(-30.47 -58.05)"
                  fill="#fe5e41"
                  opacity="0.1"
                />
                <path
                  d="M644.32,717v-24.3l11.2,11.2,2.8-2.9-16-16-16,16,2.8,2.79,11.2-11.09V717Z"
                  transform="translate(-30.47 -58.05)"
                  fill="#fe5e41"
                  opacity="0.1"
                />
